...
| 단계 | 한국어 이름 | 토큰 임계치 (medium) | 수염(당신) | Claude 반응 | 멘트(예) |
|---|---|---|---|---|---|
| ① | 매끈 | 0~50K | `\___/` | `(◕ᴗ◕)` | "오늘도 잘 부탁해요 아빠!" |
| ② | 까끌까끌 | 50~300K | `\,,,/` | `(•_• )` | "아빠 오늘 좀 까끌까끌해..." |
| ③ | 북슬북슬 | 300K~1.5M | `\vvvv/` | `(>﹏<)` | "아... 따가워요... 잠깐 쉬어가요?" |
| ④ | 따갑따갑 | 1.5M~5M | `\WWWWW/` | `(╥﹏╥)` | "아빠 무서워요... 면도하고 와요..." |
| ⑤ | 고슴도치 | 5M+ | `\MWMWMWM/` | `(;﹏;)` | "이제 안아주기 힘들어요... 푹 쉬다 와요" |
