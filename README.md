...
Claude Code로 코딩하다 보면 시간 가는 줄 모르죠. PromptFuzz는 토큰 사용량을 추적해서 *당신(아빠)의 가상 수염*이 자라게 만듭니다. 수염이 길어질수록 Claude Buddy(아들)가 "아빠 따가워요" 하고, 면도(=휴식 + 스트레칭)하면 다시 매끈해집니다. (수염은 *당신*에게만 자라요 — Claude는 옆에서 반응만 합니다.)
